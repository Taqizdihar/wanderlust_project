...
<body>
    ...
    <main class="faq-container">
        ...
        <div class="faq">
            <h3>Apa itu Wanderlust?</h3>
            <p>Wanderlust adalah platform digital yang menyediakan berbagai informasi, tips, dan layanan pemesanan terkait destinasi wisata.</p>
        </div>
        <div class="faq">
            <h3>Bagaimana cara memesan tiket?</h3>
            <p>Anda dapat memesan tiket melalui halaman <a href="PemesananTiket.php">Pemesanan Tiket</a> dengan mengisi form dan memilih metode pembayaran.</p>
        </div>
        <div class="faq">
            <h3>Apakah tersedia panduan wisata?</h3>
            <p>Ya, kami menyediakan artikel dan tips yang dapat membantu Anda selama perjalanan di halaman <a href="Tips.php">Tips</a>.</p>
        </div>
    </main>
