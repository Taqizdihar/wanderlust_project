  ...
  <div class="wrapper">
    <aside class="sidebar">
      ...
      <ul>
        ...
        <li><a href="?page=acc_wisata" class="<?= $page === 'acc_wisata' ? 'active' : '' ?>">ACC Transaksi</a></li>
        <li><a href="?page=acc_wisata" class="<?= $page === 'acc_wisata' ? 'active' : '' ?>">Daftar Member</a></li>
        <li><a href="?page=acc_wisata" class="<?= $page === 'acc_wisata' ? 'active' : '' ?>">Log out</a></li>
      </ul>
    </aside>
    <main class="main">
      <?php if ($feedback): ?>
      ...
      <?php elseif ($page === 'acc_wisata'): ?>
        ...
        <div class="card">
          ...
          <table>
            <thead>
              <tr>
                <th>ID</th><th>Nma</th><th>Lokasi</th><th>Diajukan Oleh</th><th>Aksi</th>
              </tr>
            </thead>
            <tbody>
              <tr>
